...
import { TrendingUp, Award, Rocket, Shield } from "lucide-react"

const revenueCategories = [
  { name: "Seed rounds", icon: Rocket, color: "#3b82f6" },
  { name: "Series A+", icon: TrendingUp, color: "#10b981" },
  { name: "Grants", icon: Award, color: "#8b5cf6" },
  { name: "Accelerator prizes", icon: Shield, color: "#f59e0b" },
]
  ...
  return (
    ...
    >
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-slate-900">Funding Raised</h3>
