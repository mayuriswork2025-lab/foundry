...
const features = [
  "Register your startup in 5 minutes",
  "Founder verification included",
...
const allTransactions = [
  { name: "EcoTrack", amount: "+$2,400", category: "Funding received", color: "from-emerald-400 to-teal-500" },
  { name: "FinFlow", amount: "+$1,850", category: "Funding received", color: "from-blue-400 to-indigo-500" },
  { name: "MedLink", amount: "+$1,200", category: "Funding received", color: "from-amber-400 to-orange-500" },
  { name: "AgroSense", amount: "+$3,500", category: "Funding received", color: "from-rose-400 to-pink-500" },
  { name: "EduSpark", amount: "+$750", category: "Funding received", color: "from-violet-400 to-purple-500" },
  { name: "UrbanGrid", amount: "+$1,100", category: "Funding received", color: "from-cyan-400 to-blue-500" },
  { name: "ByteForge", amount: "+$2,800", category: "Funding received", color: "from-lime-400 to-green-500" },
  { name: "NimbusAI", amount: "+$950", category: "Funding received", color: "from-fuchsia-400 to-pink-500" },
]
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-normal mb-6 text-balance font-serif">
                Manage your startup journey with ease
              </h2>
              <p className="text-muted-foreground leading-relaxed text-lg">
                Track milestones, manage mentor sessions, and communicate with your team from a single intuitive and
                modern interface.
              </p>
            </motion.div>
