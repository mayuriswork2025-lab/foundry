      ...
      <footer id="contact" className="relative z-20 border-t border-border py-16 px-6 bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              <a href="/" className="flex items-center gap-2 mb-4">
                ...
                <span className="text-base font-medium text-foreground">Foundry</span>
              </a>
              <p className="text-sm text-muted-foreground mb-6">Turning bold ideas into real startups.</p>
          ...
          <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-xs text-muted-foreground">Foundry Inc. - Startup incubation platform</p>
          </div>
        </div>
      </footer>
    </div>
