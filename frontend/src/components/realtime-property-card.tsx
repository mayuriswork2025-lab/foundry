...
const defaultTopProperties = [
  { page: "EcoTrack", visitors: 245 },
  { page: "FinFlow", visitors: 189 },
  { page: "MedLink", visitors: 156 },
  { page: "AgroSense", visitors: 98 },
]
    ...
    >
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <h3 className="text-lg font-semibold text-slate-900">Startup Activity</h3>
      ...
      <div className="mb-6 grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-sm opacity-80">Startup Views</p>
          </div>
          <AnimatePresence mode="wait">
            <motion.p
              key={pageViews}
      ...
      <div>
        <p className="mb-3 text-sm font-medium text-slate-700">Trending Startups</p>
