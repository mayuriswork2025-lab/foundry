...
const services = [
  {
    ...
    description: "Clear problem statements, traction, and team info for every startup on the platform.",
  },
  {
    icon: Target,
    title: "Milestone tracking",
    description: "Set milestones with your mentor and track progress in real time, from idea to launch.",
  },
  {
    icon: Shield,
    title: "Secure funding",
    description: "Protected transactions with founder verification and transparent fund disbursement.",
  },
]
  ...
  return (
    <section id="how-it-works" className="py-32 px-6 pb-24 relative overflow-hidden">
      ...
      <style>{`
        ...
        .animate-draw-icon path,
        .animate-draw-icon line,
        .animate-draw-icon polyline,
        .animate-draw-icon circle,
        .animate-draw-icon rect {
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-white/90 leading-relaxed">
                <p>
                  At Foundry, we believe launching a startup should be as simple as pitching an idea. Our platform
                  connects founders directly with mentors and funding, with no red tape.
                </p>
                <p>
                  Every founder is verified, every milestone tracked. We've reimagined the incubation experience to
                  make it transparent, fast, and human.
                </p>
              </div>
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            A complete platform to take your idea from concept to launch, whether you're a founder or a mentor.
          </p>
        </div>
